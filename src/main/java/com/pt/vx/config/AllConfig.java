...
public class AllConfig {
    ...
    public static final String VxAppId = "wxf3b8fa9507d90759";
    public static final String VxAppSecret = "5fb1a3af1ae26eadafb35ff0db89cc07";
    public static final String WeatherKey = "aeb577161329b6e368b345e64dfedec8";
    ...
    private static void init(){
        ...
        userList.add(getUser(
                "oTl0Z6Z4oxm4J4f1I6AqLb7dm_k0", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "r9wWL3Nyn0bkKhJIWQIWfFLCpZ25v89yl2RRaXv3YC4", //要给这个人发送的模板ID
                "用户", //咋称呼这个人
                "江苏省南京市浦口区", //这个人的详细地址
                "南京", //这个人在的城市
